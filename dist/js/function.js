...
var uaSet = __webpack_require__(283);
...
var smoothScrollSet = __webpack_require__(280);
var animationStepSet = __webpack_require__(281);
...
var initSet = function () {
	...
	_createClass(initSet, [{
		...
		value: function DOMReadAfter(op) {
			...
			var btnAnimation = new animationStepSet('.animationSet');
			btnAnimation.set();
		}
	}, {
		key: 'imageReadAfter',
...
module.exports = function () {
	function animationStepSet(target) {
		_classCallCheck(this, animationStepSet);

		this.target = target;
	}

	_createClass(animationStepSet, [{
		key: 'set',
		value: function set() {
			var main = function () {
						...
						while (1) {
							switch (_context.prev = _context.next) {
								...
								case 1:
									...
									_context.next = 4;
									return animationSet($target);

								case 4:
									animation = _context.sent;
			...
			var actionSet = function actionSet() {
				var timeoutId = void 0;
				var ac = $target.data('action');
